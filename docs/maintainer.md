...
- Keep `GIT_LEGO_VERSION=0.7.0` until the version is explicitly changed.
...
4. Update `README.md`, `docs/implementation-summary.md`, `docs/technical_docs.md`, and `skills/git-lego/SKILL.md` when user-facing behavior changes.
