...
assert_file_contains help.txt "Read or update manifest-backed and local settings."
assert_file_contains help.txt "clone-mode (per-path, manifest): full, partial."
assert_file_contains help.txt "clone-mode controls future restore clones, not the clone command."
assert_file_contains help.txt "Explicit config list shows settings from both the manifest and .gitnest-rc."
...
assert_file_contains help.txt "foreach [--include-root-first|--include-root-last] [--only-nested|--no-nested] [--finally <cmd>] [--finally-no-error <cmd>] [--finally-on-error <cmd>] [--] <command> [args...]"
assert_file_contains help.txt "foreach-modified [--continue-on-error] [--finally <cmd>] [--finally-no-error <cmd>] [--finally-on-error <cmd>] [--porcelain | --json | --json-pretty]"
assert_file_contains help.txt "foreach-clean [--continue-on-error] [--finally <cmd>] [--finally-no-error <cmd>] [--finally-on-error <cmd>] [--porcelain | --json | --json-pretty]"
