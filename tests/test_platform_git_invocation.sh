...
assert_file_contains help.txt "Only clone-mode is currently configurable; values are full or partial."
...
assert_file_contains help_config.txt "clone-mode values are full or partial."
...
assert_file_contains help_absorb.txt "This removes the subproject from the current nest and stages its files in the nest root."
assert_file_contains help_absorb.txt "Opposite: extract converts outer-repo tracked files into a managed subproject."
