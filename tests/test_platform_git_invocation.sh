...
assert_file_contains help.txt "snapshot [--recursive] [--quiet] [--dry-run] [--no-fetch] [--base <subproject>=<ref>]"
assert_file_contains help.txt "Snapshot local manifest state without pushing."
assert_file_contains help.txt "upload [--finalize] [--dry-run] [--no-fetch] [--base <subproject>=<ref>]"
assert_file_contains help.txt "freeze [--force] [--only <path>[,<path>...]] [--dry-run]"
assert_file_contains help.txt "finalize <subproject> [--dry-run] [--cleanup] [--revision <sha> | --tag <tag> | --use-target-head]"
assert_file_contains help.txt "sync [--recursive] [--prune] [--force] [--dry-run]"
