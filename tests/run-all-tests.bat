...
rem forwarded unchanged to run-all-tests.sh, including the commands list,
rem only <ids>, except <ids>, cleanup, and help, and the options --verbose,
rem --stop-on-fail, --no-log, and --log FILE.
